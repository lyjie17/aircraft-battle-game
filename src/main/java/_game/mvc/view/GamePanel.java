...
public class GamePanel extends Panel {
    ...
    public GamePanel(Dimension dim) {
        ...
        gameFrame.setTitle("Game.java Base");
    ...
    public void update(Graphics g) {
        ...
        if (CommandCenter.getInstance().isGameOver()) {
            displayTextOnScreen(grpOff,
                    "Aircraft Battle",
                    "-Press the LEFT and RIGHT arrow keys to turn your falcon",
                    "-Press the UP arrow keys to thrust (falcon shown in orange color)",
            ...
            displayTextOnScreen(grpOff, "Game.java Paused");
        }
